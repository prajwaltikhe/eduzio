export const features = [
  {
    ...
    caption: 'Effortless Learning',
    title: 'Learn smarter, not harder',
    text: "Eduzio revolutionizes the learning process. With intuitive tools and streamlined workflows, you'll accomplish more with less effort. It's like having a personal mentor, but even better.",
    button: {
  ...
  },
  {
    ...
    title: 'Your learning, safe and sound',
    text: 'At Eduzio, we prioritize your privacy. With state-of-the-art security and robust data protection, your personal information stays safe, letting you focus on what matters most: learning.',
    button: {
...
export const faq = [
  {
    id: '0',
    question: 'How easy is it to set up Eduzio?',
    answer:
      'Getting started with Eduzio is quick and easy. With our intuitive design, you can start learning in no time.',
  },
  {
    id: '1',
    question: 'Can I integrate Eduzio with other tools?',
    answer:
      'Yes! Eduzio is compatible with various platforms, allowing you to enhance your learning experience by integrating it with your existing tools.',
  },
  {
    id: '2',
    question: 'How often do you update the content?',
    answer:
      'We continuously refresh our content to ensure it remains relevant and aligned with the latest developments in education.',
  },
  {
    id: '3',
    question: 'What is your refund policy?',
    answer:
      "We offer a 30-day money-back guarantee to ensure you're satisfied with your Eduzio experience.",
  },
  {
    id: '4',
    question: 'Do you provide corporate plans?',
    answer:
      'Yes! We offer customized plans for businesses and organizations, designed to support team learning and growth.',
  },
  {
    id: '5',
    question: 'What happens when I run out of storage?',
    answer:
      'If you run out of storage, you can easily upgrade your plan or manage your resources to free up space.',
  },
  {
    id: '6',
    question: 'Can I upgrade my plan?',
    answer:
      'Yes, you can upgrade to a higher plan at any time, unlocking additional features and storage with a smooth transition.',
  },
  {
    id: '7',
    question: 'How do I invite my team to Eduzio?',
    answer:
      'Inviting your team is simple. Use our team management tools to send invitations and start collaborating immediately.',
  },
  {
    id: '8',
    question: 'Do you offer training for teams and individuals?',
    answer:
      'Yes! We offer personalized training sessions for both individuals and teams to maximize the effectiveness of your learning journey.',
  },
  {
    id: '9',
    question: 'I’m locked out of my account. What should I do?',
    answer:
      'Don’t worry! Our support team is here to help you regain access to your account quickly.',
  },
];
...
export const plans = [
  {
    ...
    priceMonthly: 19,
    priceYearly: 12,
    caption: 'Ideal for solo learners',
    features: [
      '100MB Cloud Storage',
  ...
  },
  {
    ...
    priceMonthly: 39,
    priceYearly: 29,
    caption: 'Great for teams',
    features: [
      'All Pro Features',
      '10TB Additional Storage',
      'Discounted Member Plans',
...
export const testimonials = [
  {
    ...
    role: 'Global Learners',
    avatarUrl: '/images/testimonials/jessica-saunders.png',
    comment:
      "Eduzio's support team has been a game-changer! They’re incredibly responsive and have made my learning experience much smoother.",
  },
  {
    id: '1',
    name: 'Mark Erixon',
    role: 'Vid Education Intl',
    avatarUrl: '/images/testimonials/mark-erixon.png',
    comment:
      "At first, I was skeptical, but Eduzio has truly transformed my approach to learning. It's an outstanding platform.",
  },
  {
    id: '2',
    name: 'Melanie Hurst',
    ...
    comment:
      'Getting started with Eduzio was effortless. It has greatly streamlined my daily study sessions.',
  },
  {
    id: '3',
    name: 'Alicia Barker',
    ...
    comment:
      'The analytics tools are fantastic. They’ve given me deep insights into my study patterns and helped me improve my efficiency.',
  },
  {
    id: '4',
    name: 'Becky Snider',
    role: 'Knowledge Clips',
    avatarUrl: '/images/testimonials/becky-snider.png',
    comment:
      "Switching to Eduzio was the best decision ever. It has completely transformed our team's learning workflow.",
  },
  {
    id: '5',
    name: 'Jim Bradley',
    ...
    comment:
      'Eduzio has had a huge impact on productivity. It’s changed how our team learns and grows together.',
  },
];
