              ...
              {details.map((detail) => (
                <li key={detail.id} className='relative pt-16 px-4 pb-14'>
                  <div className='absolute top-8 bottom-0 left-1/2 bg-s3/20 w-[1px] h-full z-10'>
                    <div className='flex items-center justify-center mx-auto mb-3 border-2 border-s2 rounded-full hocer:border-s4 transition-all duration-500 shadow-500 size-20'>
                      <img
                        src={detail.icon}
                        alt={detail.title}
